 ...
 * @author Dell Vostro
 */
public class BieuDo2 extends javax.swing.JPanel {
    ...
    void Jchart() {
        ...
        try {
            ...
            String sql = "SELECT COUNT(MaHoaDon),MONTH(NgayThanhToan)\n"
                    + "FROM HoaDon\n"
            ...
            for (int i = 0; i <= (data.capacity() / 2) - 1; i++) {
                ...
                switch (Integer.parseInt((String) jTable1.getValueAt(i, 1))) {
                    case 1:
                        s1 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 2:
                        s2 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 3:
                        s3 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 4:
                        s4 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 5:
                        s5 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 6:
                        s6 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 7:
                        s7 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 8:
                        s8 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 9:
                        s9 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 10:
                        s10 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 11:
                        s11 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    case 12:
                        s12 = Double.parseDouble((String) jTable1.getValueAt(i, 0));
                        break;
                    default:
                }
            }
        ...
        JFreeChart chart = ChartFactory.createBarChart("Thống kê khách hàng hằng tháng năm " + jComboBox1.getSelectedItem(), "", "Số lượng khách", dataSet, PlotOrientation.VERTICAL, false, false, false);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BIỂU ĐỒ THỐNG KÊ KHÁCH HÀNG");
